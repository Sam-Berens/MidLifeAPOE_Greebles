...
# --- Get the condition codes for zAge and e4 ---
...
# Check the order of model coefficients (Intercept, hAmbi, zAge, E4)
# e33
...
# all
x_lo_age1 <- t(c(1, 0, x_zage[1], 0.5))
x_hi_age1 <- t(c(1, 1, x_zage[1], 0.5))
x_lo_age2 <- t(c(1, 0, x_zage[2], 0.5))
x_hi_age2 <- t(c(1, 1, x_zage[2], 0.5))
x_lo_age3 <- t(c(1, 0, x_zage[3], 0.5))
x_hi_age3 <- t(c(1, 1, x_zage[3], 0.5))
x_lo_age4 <- t(c(1, 0, x_zage[4], 0.5))
x_hi_age4 <- t(c(1, 1, x_zage[4], 0.5))
...
conditions <- data.frame(
                         Condition = c(rep("Low", 8), rep("High", 8), rep("Low", 4), rep("High", 4)),
                         Genotype = c(
                                      rep("e33", 4),
                                      rep("e4p", 4),
                                      rep("e33", 4),
